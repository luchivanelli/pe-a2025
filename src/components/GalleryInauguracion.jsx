...
const GalleryInauguracion = ()=> {
    ...
    return (
        <div>
            ...
            <button onClick={handleLoad} className="border-2 border-yellow px-3 py-0.5 flex justify-center rounded-md mx-auto my-2 font tracking-wider hover:bg-yellow hover:text-blue transition-all">Cargar más</button>
